...
export type QuotaProviderType = 'claude' | 'codex';
export type OAuthConfigLoadError = 'loading' | 'unsupported' | 'load' | null;

export const QUOTA_PROVIDER_TYPES = new Set<QuotaProviderType>(['claude', 'codex']);

export const OAUTH_PROVIDER_PRESETS = ['claude', 'codex'];
...
export const AUTH_FILE_WEBSOCKET_PROVIDERS = new Set(['codex']);
export const AUTH_FILE_USING_API_PROVIDERS = new Set<string>();
export const AUTH_FILE_MANUAL_REFRESH_PROVIDERS = new Set(['claude', 'codex']);
...
export const THEME_SURFACE_ICON_PROVIDERS = new Set<string>();
