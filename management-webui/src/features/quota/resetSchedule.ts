...
/* Structural shapes shared by the supported quota states. */
 ...
 *
 * Only genuine capacity-return events are collected. Codex subscription
 * renewal dates are excluded because they are not rate-limit resets.
 */
