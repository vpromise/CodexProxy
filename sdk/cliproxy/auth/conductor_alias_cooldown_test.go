...
func TestManagerExecute_ModelAliasRequestNotBlockedByOtherModelQuotaCooldown(t *testing.T) {
	const (
		provider     = "codex"
		requestModel = "quota-alias-model"
		targetModel  = "quota-target-model"
		otherModel   = "quota-other-model"
	)
